...
const Cart = ({courses, credit, remainingCredit, totalPrice}) => {
    return (
        <div className="bg-base-100 shadow-xl pl-6 py-6 pr-2 text-left">
            <h2 className="text-[#2F80ED] font-bold text-sm">Credit Hour Remaining {remainingCredit}hr</h2>
            <br /><hr /> <br />
            ...
            <br /><hr /> <br />
            <h2 className="font-semibold text-[#1c1b1bcc] text-sm">Total Credit Hour: {credit}</h2>
            <br /><hr /> <br />
            <h2 className="font-semibold text-[#1c1b1bcc] text-sm">Total Price: {totalPrice} USD</h2>
